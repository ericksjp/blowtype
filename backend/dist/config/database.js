...
const seedData = () => {
    ...
    if (existingBooks.count === 0) {
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `);
        const bookResult = insertBook.run('Dom Casmurro', 'Machado de Assis', 1899, 'Dom Casmurro é um dos maiores clássicos da literatura brasileira, escrito por Machado de Assis. A obra conta a história de Bentinho, um homem introspectivo e ciumento que revisita suas memórias da juventude, marcado pelo relacionamento com Capitu. Com uma narrativa rica em ironia e ambiguidade, o romance aborda temas como ciúmes, dúvida, religiosidade, traição e memória, deixando ao leitor a tarefa de julgar o que é verdade ou invenção.', 15, 256);
